...
type CityForm = { name: string; code: string; province: string; isActive: boolean; sortOrder: number };
const EMPTY_FORM: CityForm = { name: '', code: '', province: '', isActive: true, sortOrder: 0 };
